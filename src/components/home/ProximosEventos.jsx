...
import { Clock, MapPin, User, CheckCircle2, Loader2 } from 'lucide-react';
        ...
        {proximosEventos.map((event, idx) => {
          ...
          return (
            <motion.div
              ...
              className="p-4 rounded-lg bg-gray-900/50 border border-gray-700/30 hover:border-gray-600/50 transition-all group"
            >
