                  ...
                  <div className="px-4 pb-4 pt-1 border-t border-emerald-500/20 bg-emerald-500/5">
                    ...
                    <div className="flex gap-2">
                      <div className="flex-1 relative">
                        <span className="absolute left-3 top-1/2 -translate-y-1/2 text-xs text-gray-400 font-mono">R$</span>
                        <Input
                          type="number"
                          min="0"
                          step="0.01"
                          ...
                          className="pl-8 bg-gray-800/80 border-emerald-500/30 text-white h-9 text-sm font-mono"
                        />
                      </div>
                      <button
                        type="button"
